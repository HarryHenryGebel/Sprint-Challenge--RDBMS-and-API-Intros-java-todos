...
- [x] TODOS
  ...
  - `todo_id` primary key, not null long
  - `description` string, not null
  - `completed` boolean. Note that for all new todos, default completed to false
  - `user_id` foreign key (one user to many todos) not null
...
- [x] GET /users/user/{id} - return the user and their todos based off of user id.
...
- [x] PATCH /todos/todo/{id} - mark a todo as completed.

- [x] DELETE /users/user/{id} - Deletes a user based off of their userid and deletes all their associated todos.
